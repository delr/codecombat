module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  ...
  signup:
    ...
    teacher_email_announcements: "通知我有关教师资源，学业安排和课程的更新！"
    creating: "账户创建中……"
    sign_up: "注册"
    log_in: "登录"
    ...
    finish: "完成"
    teacher_ready_to_create_class: "您已经可以开始创建您的第一个课程了！"
    teacher_students_can_start_now: "您的学生已经可以立刻开始玩第一个课程了，计算机科学入门。"
    teacher_list_create_class: "在下一个屏幕您可以创建您的第一个课程。"
    teacher_list_add_students: "点击'查看课程'链接，以添加学生到班级内，然后将班级码或URL发给学生。您也可以通过email邀请他们，如果他们有email地址。"
    teacher_list_resource_hub_1: "看一看"
...
#    teacher_list_resource_hub_5: "for curriculum guides, activities, and more!"
  ...
  play_level:
    ...
    finished_hoc: "我完成了我的Hour of Code"
    ...
    share_this_project: "和你的朋友或家人分享这个项目！"
    ready_to_share: "准备好发布你的项目了吗？"
